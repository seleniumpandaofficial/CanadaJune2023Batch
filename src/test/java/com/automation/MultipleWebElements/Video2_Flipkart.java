...
public class Video2_Flipkart {
	...
	public void flipKart() {
		...
		for (int i = 0; i < formalShirts.size(); i++) {
			System.out.println(formalShirts.get(i).getText() + "-->" + description.get(i).getText() + "-->"
